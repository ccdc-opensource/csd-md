...
## Step 1: Install a local miniconda3 in your home directory to avoid interfering with the CCDC one: 
```
...
## Step 4: Add the PATHS to CSD databases and the license to your .bashrc file in your home directory.
